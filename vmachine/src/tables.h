...
#define REG_fa (*(int32_t*)(memory + 20))
#define REG_fb (*(int32_t*)(memory + 28))
#define REG_fc (*(int32_t*)(memory + 36))
#define REG_ia (*(int32_t*)(memory + 44))
#define REG_ib (*(int32_t*)(memory + 48))
#define REG_ic (*(int32_t*)(memory + 52))
#define REG_id (*(int32_t*)(memory + 56))
